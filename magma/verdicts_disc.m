// =====================================================================
// Entry point: per-pair verdict report, discriminant ordering
// =====================================================================
//
//     magma -b n:=20 i:=297 verdicts_disc.m
//
// See lib/verdict_report.m for how to read the output.  Same load order as
// compute_disc.m, with verdict_report.m in place of driver.m.
...
if assigned n and assigned i then
    ...
    print "Error: need both. Use: magma -b n:=<degree> i:=<index> verdicts_disc.m";
end if;
quit;
