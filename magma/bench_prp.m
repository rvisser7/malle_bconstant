// =====================================================================
// Entry point: timing breakdown, product-of-ramified-primes ordering
// =====================================================================
//
//     magma -b n:=15 [idxfile:=idx.txt] bench_prp.m
//
...
if assigned n then
    ...
    print "Error: no degree. Use: magma -b n:=<degree> [idxfile:=path] bench_prp.m";
end if;
quit;
