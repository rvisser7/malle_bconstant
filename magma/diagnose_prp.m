// =====================================================================
// Entry point: policy diagnostic, product-of-ramified-primes ordering
// =====================================================================
//
//     magma -b n:=12 [idxfile:=idx.txt] diagnose_prp.m
//
...
//
// Same load order as compute_prp.m, plus diagnose_body.m in place of
...
if assigned n then
    ...
    DiagnoseIndices(n_int, indices, "prp");
else
    print "Error: no degree. Use: magma -b n:=<degree> [idxfile:=path] diagnose_prp.m";
end if;
quit;
